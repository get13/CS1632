public class Room
{
    ...
    {
        return (this._hasSugar) || (this._hasCream) || (this._hasCoffee);
    }
    ...
    {
        return this._hasCream;
    }

    public boolean hasCoffee()
    {
        return this._hasCoffee;
    }

    public boolean northExit()
    {
        return this._northExit;
    }
    ...
    {
        this._hasCoffee = hasCoffee;
        this._hasCream = hasCream;
        this._hasSugar = hasSugar;
        this._northExit = northExit;
        this._southExit = southExit;
